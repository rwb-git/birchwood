...
*/
   ...
   include 'air_functions.php';   // this is only called here, but leave it because smaller files are easier to manage. or bring it here. // del
...
//------------------------------------- main program --------------------------------------------
   ...
   $tank_plot_h = 300;       // height of plot. old tank plot is 200

   $sep = 10;     // space between slave and tank

   $tank_y1 = $sep + $top_pad + 2 * $bits_h;          // y location of top of tank plot. was 6 for 6 plots
