<?php
   ...
   include 'generic_1.php';   // this is only called here, but leave it because smaller files are easier to manage. or bring it here.  // del
...
// ---- horizontal lines for tank level plot -------------------
   ...
   $label_delt = 10;  // put 10 here for 10 at the next to the bottom line and 20 30 40; put 200 here for 200 400 600
...
// --------------------- line at very top
   ...
   include 'status_rows.php';  // this is only called here, but leave it because smaller files are easier to manage. or bring it here. 

   include 'tank_status.php'; // this is only called here, but leave it because smaller files are easier to manage. or bring it here. 
...
imagettftext($my_img->img, 12, 0,  (int)($left_pad * 1/4), (int)(($tank_y1 + $tank_y2) /2 - 50) ,  $text_colour, $lib_font, "  Tank Level");   // img, size, angle, x, y, color, font, text

imagettftext($my_img->img, 12, 0,  (int)($left_pad * 1/4), (int)(($tank_y1 + $tank_y2) /2 + 50) ,  $blue, $lib_font, "  Air Pressure");   // img, size, angle, x, y, color, font, text
