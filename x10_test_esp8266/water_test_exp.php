...
<img src="mk_new_expanded_fake.php/?p=101">  <!-- if p value > 100 then debug is turned on and p - 100 = plot hours -->
...
<?php             # this works: http://birchwood.c1.biz/get.php/?tank=75&status=37
...
function show_elapsed($phs){     //---------------------------------------------------------------------------
   ...
   if ($seconds_since_last_packet > (15 * 60)){
