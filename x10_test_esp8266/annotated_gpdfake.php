...
echo 'year and day to make date33  ',$year,' ',$day;          
echo '<br>';

echo 'date33 line 238 ',$date33->format('d');          
echo '<br>';

echo 'year from date33 line 244 ',$date33->format('Y');          
echo '<br>';
...
if ($debug ==1){
echo 'date33 if day == 60 ',$date33->format('d');          
echo '<br>';
}
                        } else {
...
if ($debug ==1){
echo 'date33 else ',$date33->format('d');          
echo '<br>';
}
...
if ($debug ==1){
echo 'date33 else not leap',$date33->format('d');          
echo '<br>';
}
...
if ($debug ==1){
echo 'date33 final value',$date33->format('d');          
echo '<br>';
}
